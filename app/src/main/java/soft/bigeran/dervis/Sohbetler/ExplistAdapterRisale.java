...
public class ExplistAdapterRisale extends BaseExpandableListAdapter{

    private Context context;
    private ArrayList<String> basliklar;
    private HashMap<String, ArrayList<String>> icerik;

    public ExplistAdapterRisale(Context context, ArrayList<String> basliklar,
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_itemrisale, null);
        }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.liste_gruprisale, null);
