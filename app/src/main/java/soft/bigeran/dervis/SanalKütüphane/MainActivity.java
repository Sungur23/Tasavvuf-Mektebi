...
public class MainActivity extends AppCompatActivity {
   ...
   private TabAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sanalk);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(soft.bigeran.dervis.SanalKütüphane.MainActivity.this, soft.bigeran.dervis.AnaEkran.MainActivity.class);
