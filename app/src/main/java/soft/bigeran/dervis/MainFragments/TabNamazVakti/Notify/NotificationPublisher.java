...
public class NotificationPublisher extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        try {
            soft.bigeran.dervis.MainFragments.TabNamazVakti.Notify.Notification.NotificationDBHelper mDbHelper = new soft.bigeran.dervis.MainFragments.TabNamazVakti.Notify.Notification.NotificationDBHelper(context);
