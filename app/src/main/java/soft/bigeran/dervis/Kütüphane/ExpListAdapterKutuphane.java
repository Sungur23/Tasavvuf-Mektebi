...
public class ExpListAdapterKutuphane extends BaseExpandableListAdapter{

	private Context context;
	private ArrayList<String> basliklar;
	private HashMap<String, ArrayList<String>> icerik;

	public ExpListAdapterKutuphane(Context context, ArrayList<String> basliklar,
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.list_view_itemkutuphane, null);
		}
		...
		if(groupPosition==0)
		{
			if(childPosition==0)
			{
				itemimaj.setBackgroundResource(R.drawable.mana); ;
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			convertView = inflater.inflate(R.layout.liste_grupkutuphane, null);
