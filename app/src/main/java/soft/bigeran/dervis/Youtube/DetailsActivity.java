...
import soft.bigeran.dervis.Youtube.adapters.CommentAdapter;
import soft.bigeran.dervis.Youtube.models.YoutubeCommentModel;
import soft.bigeran.dervis.Youtube.models.YoutubeDataModel;

public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    private static final int READ_STORAGE_PERMISSION_REQUEST_CODE = 1;
    private static String GOOGLE_YOUTUBE_API = "AIzaSyB8IvnuT6cd-zPOvyPElEHAt4rW_vKCwgQ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.youtube_detay);
    ...
    @SuppressLint("StaticFieldLeak")
    public void youtubedaw(View view) {
    ...
    private class RequestDownloadVideoStream extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage(".Video indiriliyor Lütfen Bekleyin..");
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (huc != null) {
                    ...
                    String storagePath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+"/TasavvufMektebi";
