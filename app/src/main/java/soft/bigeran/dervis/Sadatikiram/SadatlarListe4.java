...
public class SadatlarListe4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sadatlar_liste4);
        initialize();
    ...
    private void initialize() {
        ...
        listViewAdapter = new soft.bigeran.dervis.Sadatikiram.Adapter.SadatAdapter(SadatlarListe4.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        Person person38	= new Person("	Şeyh Muhammed Masum Haznevi (ks.)"+38	, "(1913-1958)", R.drawable.photo121);	persons.add(person38	);
        Person person39	= new Person("	Şeyh Alaaddin Haznevi (ks.)"+39	, "(*-1963)", R.drawable.photo121);	persons.add(person39	);
        Person person40	= new Person("	Şeyh İzzeddin Haznevi (ks.)"+40	, "(1923-1992)", R.drawable.photo121);	persons.add(person40	);
        Person person41	= new Person("	Şeyh Muhammed Haznevi (ks.)"+41	, "(*-2005)", R.drawable.photo121);	persons.add(person41	);
