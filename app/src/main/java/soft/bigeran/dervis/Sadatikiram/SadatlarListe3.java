...
public class SadatlarListe3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sadatlar_liste3);
        initialize();
    ...
    private void initialize() {
        ...
        listViewAdapter = new soft.bigeran.dervis.Sadatikiram.Adapter.SadatAdapter(SadatlarListe3.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        Person person40	= new Person("	Şeyh Muhammed Konyevi Hz. (K.s)    	"+40,"*", R.drawable.photo121);	persons.add(person40	);
