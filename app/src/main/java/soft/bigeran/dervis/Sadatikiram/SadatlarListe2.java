...
public class SadatlarListe2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sadatlar_liste2);
        initialize();
    ...
    private void initialize() {
        ...
        listViewAdapter = new soft.bigeran.dervis.Sadatikiram.Adapter.SadatAdapter(SadatlarListe2.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        Person person40	= new Person("	Gavs-ı Sani Şeyh Seyyid Abdulbaki Hz. (K.s)    	"+40,"*", R.drawable.photo121);	persons.add(person40	);
