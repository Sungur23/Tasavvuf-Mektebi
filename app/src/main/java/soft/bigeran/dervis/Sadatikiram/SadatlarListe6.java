...
public class SadatlarListe6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sadatlar_liste6);
        initialize();
    ...
    private void initialize() {
        ...
        listViewAdapter = new soft.bigeran.dervis.Sadatikiram.Adapter.SadatAdapter(SadatlarListe6.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        Person person30	= new Person("	Eş-Şeyh Hâfız Ebû Saîd Sâhib(K.s)"+30	, "(*)", R.drawable.photo121);	persons.add(person30	);
        Person person31	= new Person("    Eş-Şeyh Habîbullah Cân-ı Cânan (k.s) "+31	, "(?-?)", R.drawable.photo121);	persons.add(person31	);
        Person person32	= new Person("	Eş-Şeyh Muhammed Mazhar Îşân Cân-ı Cânan (K.s)"+32	, "(?)", R.drawable.photo121);	persons.add(person32	);
        Person person33	= new Person("	Eş-Şeyh Salâhuddîn İbn-i Mevlânâ Sirâcüddin (K.s)"+33	, "(?)", R.drawable.photo121);	persons.add(person33	);
        Person person34	= new Person("	Eş-Şeyh Ebu’l-Fârûk Süleyman Hilmi(K.s)"+34	, "(?)", R.drawable.photo121);	persons.add(person34	);
