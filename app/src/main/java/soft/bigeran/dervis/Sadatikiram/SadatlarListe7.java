...
public class SadatlarListe7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sadatlar_liste7);
        initialize();
    ...
    private void initialize() {
        ...
        listViewAdapter = new soft.bigeran.dervis.Sadatikiram.Adapter.SadatAdapter(SadatlarListe7.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        Person person33	= new Person("	Şeyh Tâha’l-Harîrî  (K.s)"+33	, "(1803-1875)", R.drawable.photo121);	persons.add(person33	);
        Person person34	= new Person("	Şeyh Muhammed Es’ad Erbilî (K.s)"+34	, "(1847-1931)", R.drawable.photo121);	persons.add(person34	);
        Person person35	= new Person("	Şeyh Mahmud Sâmi Ramazanoğlu (K.s)"+35	, "(?-1899)", R.drawable.photo121);	persons.add(person35	);
        Person person36	= new Person("	Şeyh Hacı Hasan Efendi  (K.s)"+36	, "(1859-1923)", R.drawable.photo121);	persons.add(person36	);
        Person person37	= new Person("	Şeyh Ramazan Dinç Efendi  (K.s)"+37	, "(1859-1923)", R.drawable.photo121);	persons.add(person37	);
