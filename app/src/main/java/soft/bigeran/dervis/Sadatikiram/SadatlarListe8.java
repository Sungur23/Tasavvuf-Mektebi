...
public class SadatlarListe8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sadatlar_liste8);
        initialize();
    ...
    private void initialize() {
        ...
        listViewAdapter = new soft.bigeran.dervis.Sadatikiram.Adapter.SadatAdapter(SadatlarListe8.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        Person person31	= new Person("	Şeyh İsmail Enerani (k.s) "+31	, "(?-?)", R.drawable.photo121);	persons.add(person31	);
        Person person32	= new Person("	Has Muhammed Şirvani (K.s)"+32	, "(*)", R.drawable.photo121);	persons.add(person32	);
        Person person33	= new Person("	Şeyh Muhammed Yeragi (K.s)"+33	, "(*)", R.drawable.photo121);	persons.add(person33	);
        Person person34	= new Person("	Seyyid Cemalettin Gazikumuki Hüseyni (K.s)"+34	, "(*)", R.drawable.photo121);	persons.add(person34	);
        Person person35	= new Person("	Ebu Ahmet-i Sughuri(K.s)"+35	, "(*)", R.drawable.photo121);	persons.add(person35	);
        Person person36	= new Person("	Ebu Muhammed Medeni  (K.s)"+36	, "(*)", R.drawable.photo121);	persons.add(person36	);
        Person person37	= new Person("	Seyyid Şerafettin Dağıstani (K.s)"+37	, "(*)", R.drawable.photo121);	persons.add(person37	);
        Person person38	= new Person("	Sultan-ül Evliya Abdullah Dağıstani  (K.s)"+38	, "(*)", R.drawable.photo121);	persons.add(person38	);
        Person person39	= new Person("	Seyyid-üd Taife Hz. Şeyhuna Üstazina Şeyh Muhammed Nazım EI-Rabbani (Ks)"+39	, "(*)", R.drawable.photo121);	persons.add(person39	);
        Person person40	= new Person("	Şeyh Mehmed Adil el Hakkani Nakşibendi Rabbani ((K.s)    	"+40,"*", R.drawable.photo121);	persons.add(person40	);
