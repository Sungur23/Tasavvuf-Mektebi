package soft.bigeran.dervis.Sadatikiram.Adapter;
 ...
 */
public class SadatAdapter extends ArrayAdapter<Person> {
    ...
    public SadatAdapter(Context context, ArrayList<Person> persons) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_itemsadat, null);
