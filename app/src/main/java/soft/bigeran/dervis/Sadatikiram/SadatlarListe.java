...
public class SadatlarListe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sadatlar_liste);
        initialize();
    ...
    private void initialize() {
        ...
        listViewAdapter = new soft.bigeran.dervis.Sadatikiram.Adapter.SadatAdapter(SadatlarListe.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        Person person31	= new Person("	Şeyh Seyyid Abdullah Hakkari (k.s) "+31	, "(?-?)", R.drawable.photo121);	persons.add(person31	);
        Person person32	= new Person("	Seyyid Taha-yı Hakkari (K.s)"+32	, "(?-1853)", R.drawable.photo121);	persons.add(person32	);
        Person person33	= new Person("	Seyyid Sıbğatullah Arvasi Gavs-ı Hizani (K.s)"+33	, "(?-1870)", R.drawable.photo121);	persons.add(person33	);
        Person person34	= new Person("	Şeyh Abdurrahmâni Tâhi (K.s)"+34	, "(1831-1886)", R.drawable.photo121);	persons.add(person34	);
        Person person35	= new Person("	Şeyh Fethullah Verkanisi (K.s)"+35	, "(?-1899)", R.drawable.photo22);	persons.add(person35	);
        Person person36	= new Person("	Şeyh Muhammed Diyauddin (K.s)"+36	, "(1859-1923)", R.drawable.photo136);	persons.add(person36	);
        Person person37	= new Person("	Şeyh Ahmed El-Haznevi (K.s)"+37	, "(?-1949)", R.drawable.photo20);	persons.add(person37	);
        Person person38	= new Person("	Şeyh Seyyid Abdülhekim El-Hüseyni (K.s)"+38	, "(1902-1972)", R.drawable.photo77);	persons.add(person38	);
        Person person39	= new Person("	Şeyh Seyyid Muhammed Raşid El-Hüseyni (Ks)"+39	, "(1930-1993)", R.drawable.photo77);	persons.add(person39	);
        Person person40	= new Person("	Şah-ı Urfa Şeyh Seyyid Molla Abdulbaki Hz. (K.s)    	"+40,"*", R.drawable.photo121);	persons.add(person40	);
        Person person41	= new Person("	Şeyh Seyyid Fevzeddin Hz. (K.s))"+41	, "(**)", R.drawable.hatme4);	persons.add(person41	);
